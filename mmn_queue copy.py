...
class MMN(Simulation):
    ...
    def __init__(self, lambd:float, mu:float, n:int, d:int):
        ...
        # defining number of queues to consider
        if d <= -1: self.d = n 
        else: self.d = d
        self.mu = mu
...
def main():
    ...
    parser.add_argument('--d', type=int, default=-1)                 # number of queues to be monitored in supermarket model
